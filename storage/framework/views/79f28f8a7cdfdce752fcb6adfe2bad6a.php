...
<?php $component->withAttributes([]); ?>
            ...
            <div class="text-center mb-6">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Growcery Logo" class="w-20 mx-auto">
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between mt-6">
                    <?php if(Route::has('password.request')): ?>
                        <a class="underline text-sm text-gray-500 hover:text-green-600" href="<?php echo e(route('password.request')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'bg-green-600 hover:bg-green-700 ms-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-green-600 hover:bg-green-700 ms-3']); ?>
...
<?php endif; ?>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-500">New to Growcery?
                    <a href="<?php echo e(route('register')); ?>" class="text-green-600 font-semibold hover:underline">Create an account</a>
                </p>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Admin\Desktop\grocery\growcery\resources\views/auth/login.blade.php ENDPATH**/ ?>